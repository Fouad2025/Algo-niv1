...
public class CabinetMedicalSansObjet {
...
private static void decalerRendezVous(Scanner sc, List<List<String>> rendezVousList) {
    ...
    // Boucle pour obtenir une nouvelle date valide
    while (true) {
    ...
    // Boucle pour obtenir une nouvelle heure valide
    while (true) {
        ...
        // Vérifie les doublons avec les autres rendez-vous
        boolean doublon = false;
        for (List<String> existing : rendezVousList) {
    ...
    System.out.println("Rendez-vous décalé le " + newDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + " à " + newTime.format(DateTimeFormatter.ofPattern("HH:mm")));
}
